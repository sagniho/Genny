...
def send_message_get_response(assistant_id, user_message, thread_id):
    ...
    run = client.beta.threads.runs.create(
        ...
        additional_instruction="""This user is: Bruno Nutti, Whirlpool, Global EHS Sr Analyst. 
        Bruno's next two sessions from now are:  Thursday May 16, 8:30 AM – 10:00 AM, Incident Management & Occupational Health, Location: Meeting Room 2-3; Thursday May 16, 10:30 AM – 12:00 PM,  Ergonomics, Location: Meeting Room 4-5
        Bruno's conference point score is 85 and he is 5 on the leaderboard."""
