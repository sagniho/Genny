...
def main():
    User
Uploaded image
modify this to have "quick ask" question bubbles (see picture) that disappear after the first time. the quick ask should work the same way as workflow below so dont change that please (with the spinner and question popping up..)
